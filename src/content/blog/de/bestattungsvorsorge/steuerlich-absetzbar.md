---
title: "Bestattungsvorsorge Steuerlich Absetzbar"
description: "Möchten Sie alles wissen über die Bestattungsvorsorge Steuerlich Absetzbar? Kein Problem, bei uitvaartpolis-online bieten wir Ihnen ratgeber, preisvergleich und tipps."
pubDate: 2022-01-20
...
![](/wp-content/uploads/2022/02/bestattungsvorsorge-steuerlich-absetzbar.jpg)

## Die Einzelheiten der Steuerpflicht

Damit die Besteuerung mit der [Lohnsteuer](/de/sterbegeldversicherung/lohnsteuer/) ausreicht, muss der Leistungsempfänger folgende Besonderheiten beachten:
...
Hat der Erblasser eine private Sterbegeldversicherung abgeschlossen, ist kein Teil des Erlöses steuerpflichtig. Vor Abschluss dieser privaten [Sterbegeldversicherung wird ein vergleich empfohlen.](/de/)
...
1.  Die Zusage des Arbeitgebers, ein Sterbegeld zu zahlen, wird in der Regel in einer Betriebsvereinbarung oder einem Arbeitsvertrag festgehalten.
2.  Der Betrag von zwei bis drei Monatsgehältern, den der Verstorbene zuletzt bezogen hat, wird in der Regel als Bestattungszuschuss gewährt. In jedem Fall ist jedoch das Sterbegeld des Arbeitgebers steuerpflichtig und die Sterbegeldversicherung lohnsteuerpflichtig.
3.  Da die Sterbegeldversicherung nicht mehr vom Verstorbenen besteuert wird, wird derjenige steuerlich herangezogen, der sie von seinem Arbeitgeber erhalten hat. In der Regel sind dies der [Ehepartner](/de/sterbegeldversicherung/fur-eheleute/) oder die Kinder des Verstorbenen.
...
1.  Ein Experte auf diesem Gebiet kann feststellen, welchen Steuerzahler eine Sterbegeldversicherung in einem angemessenen Rahmen hält und wann eine erhebliche Steuer anfällt
2.  Der IRS hat eine ganze Reihe häufig gestellter Steuerfragen, die am besten von einem erfahrenen Steuerberater beantwortet werden. Infolgedessen sind die gesamten Steuerabzüge minimal.
3.  Um zu verstehen, wie der Arbeitgeber die Sterbegeldversicherung auf der Gehaltsabrechnung ausweist, muss auch geklärt werden, wannre das Geld kommt in diesem Szenario.
...
Arbeitgeber, die in ihren Leistungen ein Sterbegeld vorgesehen haben, werden für alle Nachweise revisionssichere Antworten erstellt haben, aber als Begünstigter des Sterbegeldes müssen Sie sich natürlich mit dieser [Frage](https://www.sueddeutsche.de/wirtschaft/finanzen-finanzamt-an-bestattungskosten-beteiligen-dpa.urn-newsml-dpa-com-20090101-200407-99-618147) befassen.

## Sonderregelungen für Beamte

[Beamte](/de/sterbegeldversicherung/fur-beamte/) erhalten steuerbegünstigte Versorgungsleistungen nach dem Beamtenversorgungsgesetz einschließlich Sterbegeld. Es ist eine einmalige Leistung und beträgt das Doppelte der regelmäßigen Bezüge des Verstorbenen.

-   Die Auszahlung erfolgt an den Ehegatten, die [Kinder](/de/sterbegeldversicherung/kinder/) oder Verwandten des Verstorbenen, die Reihenfolge bestimmt sich nach dem [Gesetz](/de/sterbegeldversicherung/gesetze/). Das Sterbegeld ist beim Leistungsempfänger als sonstige Einkünfte zu versteuern. 
